...
public class MailServiceImpl implements MailService
{
			...
			final ProductOrder order)
	{
		...
		MimeMessagePreparator preparator = new MimeMessagePreparator()
		{
					...
					throws Exception
			{
				...
				/*
				 * Additionally, let's add a resource as an attachment
				 * as well.
				 */
				helper.addAttachment("cutie.png",
						new ClassPathResource("linux-icon.png"));
	...
	public String geFreeMarkerTemplateContent(
		...
		try
		{
			content.append(FreeMarkerTemplateUtils
					.processTemplateIntoString(freemarkerConfiguration
							.getTemplate("fm_mailTemplate.txt"),
							model));
